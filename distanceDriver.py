...
for distance in distanceVariation: #Outer Loop for simulating with different number of Active d2D pairs
    output.printProgress(distance,distanceVariation) #Print progress on console
    i = 0
...
print("\n Plot Saved")
output.plotThroughput(cellRates,d2dsRates,combinedRates,distanceVariation,"Range of distance between D2D pairs (m)") #Plot the results
